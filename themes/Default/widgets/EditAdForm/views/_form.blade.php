<div class="panel-body">
  ...
  <div class="form-group">
    ...
    <div class="input-group input-group">
      <input type="hidden" id="ZxAjaxGeo" data-components="" data-max-length = "55" placeholder= "{!! trans('frontend.user.ad.choose_a_geolocation') !!}"
      name="geolocation_data" data-zedx-location-lat="{{ $ad->geolocation->location_lat }}" data-zedx-location-lng="{{ $ad->geolocation->location_lng }}"
      value="{{ old('geolocation_data') ?: $ad->geolocation->formatted_address }}">
  ...
  <div id="photos" class="row" data-text-update="{!! trans('frontend.user.ad.edit') !!}" data-text-delete="{!! trans('frontend.user.ad.delete') !!}" data-can-add-photo="{{ $adtype->can_add_pic && $adtype->nbr_pic > 0 && $adtype->can_update_pic }}" data-max-photos="{{ $adtype->nbr_pic }}" data-photos="{{ $ad->photos }}">
  ...
  <div class="form-group">
    ...
    @if ($adtype->can_add_video && $adtype->nbr_video > 0 && $adtype->can_update_video)
  ...
  <div id="videos" class="row" data-max-videos="{{ $adtype->nbr_video }}" data-videos="{{ $ad->videos }}">
