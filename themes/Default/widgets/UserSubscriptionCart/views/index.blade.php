{!! Form::open(['route' => ['user.subscription.checkout', $subscription->id]]) !!}
  <div class="panel panel-primary">
    <div class="panel-heading">
      <div class="panel-title">{!! trans("frontend.user.subscription.cart.buy_subscription") !!}</div>
    </div>
    <div class="panel-body">
      <div class="row">
        <div class="col-md-12">
          <h3><center>{{ $subscription->title }}</center></h3>
          <center>{{ $subscription->description }}</center>
    ...
    <div class="panel-footer">
      <a href="{{ route('user.subscription.index') }}" class="pull-left btn btn-primary"><i class="fa fa-reply"></i> {!! trans('frontend.user.subscription.cart.cancel') !!}</a>
      <button type="submit" class="pull-right btn btn-success"><i class="fa fa-shopping-cart"></i> {!! trans('frontend.user.subscription.cart.buy_now') !!}</button>
